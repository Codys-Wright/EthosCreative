import { makeAtomRuntime, ApiClient } from "@/features/core/client";
import { EventStream, makeEventStreamAtom } from "@/features/event-stream/client";
...
export class Api extends Effect.Service<Api>()(
  "@features/files/client/-files/files-atoms/Api",
  {
...
export class ImageCompressionClient extends Effect.Service<ImageCompressionClient>()(
  "@features/files/client/-files/files-atoms/ImageCompressionClient",
  {
...
export class FileSync extends Effect.Service<FileSync>()(
  "@features/files/client/-files/files-atoms/FileSync",
  {
...
export class FilePicker extends Effect.Service<FilePicker>()(
  "@features/files/client/-files/files-atoms/FilePicker",
  {
    scoped: Effect.gen(function* () {
