import { makeAtomRuntime, prefixLogs } from "@/features/core/client";
import { ApiClient } from "@/features/core/client";
import { Atom, Registry, Result } from "@effect-atom/atom-react";
import { EventStreamEvents } from "../domain/event-stream-rpc.js";
...
export class EventStream extends Effect.Service<EventStream>()(
  "@features/event-stream/client/EventStream",
  {
...
const runtime = makeAtomRuntime(Layer.mergeAll(EventStream.Default, ApiClient.Default));
