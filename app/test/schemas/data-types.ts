...
export const NewDataTypeSchema = DataTypeSchema.omit(
  "id",
  "createdAt",
  "updatedAt",
).annotations({
...
export type DataType = typeof DataTypeSchema.Type;
