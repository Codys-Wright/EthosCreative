...
export function QuizPreview() {
  const { quiz, currentQuestionId, setCurrentQuestionId, updateQuestion } =
    useQuizStore();
                  ...
                  >
                    <Card
                      className={cn(
                        ...
                        (question as RatingQuestion).selectedRating ===
                          rating && "bg-accent border-accent",
                      )}
                    ...
                    >
                      <CardHeader className="p-0 h-full">
                        <CardTitle
                          className={cn(
                            "flex items-center justify-center h-full font-normal text-foreground/80 text-lg",
                          )}
                        >
                          {rating}
                        </CardTitle>
              ...
              {quiz.questions.map((question) => (
                <CarouselItem key={question.id} className="pl-0">
                  <Card className="max-w-3xl mx-auto">
                    ...
                    <CardContent>{renderQuestionContent(question)}</CardContent>
                  </Card>
                </CarouselItem>
              ))}
            </CarouselContent>
