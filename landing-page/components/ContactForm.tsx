    ...
    <div className="mx-auto grid w-full max-w-7xl grid-cols-1 gap-10 px-4 py-10 md:px-6 md:py-20 lg:grid-cols-2">
      <div className="relative flex flex-col items-center overflow-hidden lg:items-start">
        ...
        <p className="mt-8 max-w-lg text-center text-base text-neutral-600 dark:text-neutral-400 md:text-left">
          Have questions about your artist type? We&apos;d love to hear from you
          and help you discover your creative path.
        </p>
        ...
        <div className="div relative mt-20 flex w-[800px] flex-shrink-0 -translate-x-10 items-center justify-center [perspective:1200px] [transform-style:preserve-3d] sm:-translate-x-0 lg:-translate-x-32">
          <Pin className="-left-5 top-1" />
          ...
          <Image
            ...
            height={700}
            alt="world map"
            className="[transform:rotateX(0deg)_translateZ(0px)_scale(1)] dark:invert dark:filter"
            priority
            unoptimized
          />
        </div>
