import { Blog } from "@/features/landing-page/types/Blog";

export const aboutContent: Blog = {
  title: "About My Artist Type",
  summary:
    "Discover the story behind My Artist Type and how it helps artists understand their creative identity.",
  date: "2024-02-14",
  author: "Adam Watts",
  authorImage: "/adam-watts profile.jpg",
  thumbnail: "/adam-watts profile.jpg",
  content: `
## Overview

The My Artist Type Quiz was developed to help artists understand themselves in much the same way as personality tests like **The Enneagram**, **The Big 5 Aspects Test**, and **Myers-Briggs** have helped so many in the general population understand their temperaments. 

> What makes this quiz unique is that it's been designed *specifically for artists*.
...
- Chef
- Designer
- Or any other kind of creator

The My Artist Type Quiz (or M.A.T. Quiz) will act as a mirror and magnifying glass to help you gain a deeper understanding of the inner workings of your artistic temperament. 
...
1. There are **10 distinct Artist Types**, each with their own strengths and weaknesses
2. Understanding where you fall on the continuum relative to other artists is helpful in navigating your path
3. The quiz provides insights at the intersection of art and commerce

## Collaborative Benefits

It can be a lot of fun to compare and contrast your results with those of your artist friends and associates. While on a deeper level, knowing each other's Artist Types can be extremely helpful in understanding the nuanced dynamics that are often at play in creative situations. 

> We're then setup to have more patience for each other's differences (and to value them more than we may otherwise have), and to navigate our collaborations more effectively.
