...
export const CourseLevel = S.Literal(
  "beginner",
  "intermediate",
  "advanced",
  "all-levels"
 ...
 */
export class CreateCourseInput extends S.Class<CreateCourseInput>(
  "CreateCourseInput"
)({
  instructorId: InstructorId,
  title: S.Trim.pipe(
 ...
 */
export class UpdateCourseInput extends S.Class<UpdateCourseInput>(
  "UpdateCourseInput"
)({
  title: S.optional(
    S.Trim.pipe(
